	...
	model: {
		services: [{
			...
			members: [{
				kind: "method",
				name: "getSettings",
				signature: "getSettings(): MathInputSettingsView",
				summary: "Read the current plugin settings.",
				jsDoc: "/** Read the current plugin settings. */"
			}, {
				kind: "method",
				name: "updateSettings",
				signature: "updateSettings(patch: MathInputSettingsPatch, signal: AbortSignal): Promise<MathInputSettingsView>",
			...
			types: [{
				name: "MathInputSettingsView",
				declaration: "export interface MathInputSettingsView { available: boolean; writable: boolean; settings: MathInputSettings; overridden: string[] }"
			}, {
				name: "MathInputSettingsPatch",
				declaration: "export type MathInputSettingsPatch = Partial<MathInputSettings>"
			}]
		}],
		events: [],
		objects: []
